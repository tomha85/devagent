...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Qualify a tamper-evident real Schneider Control Expert export corpus "
    ...
    parser.add_argument(
        "--allow-pending",
        action="store_true",
        help="Return success when the manifest is valid but required real-export families are still missing.",
    )
    parser.add_argument(
        "--single-pass",
        action="store_true",
